...
type AnyIconName = IconName | "back" | "close";

const paths: Record<AnyIconName, React.ReactNode> = {
  home: (
    <>
  ...
  simulator: (
    <>
      ...
      <circle cx="15" cy="7" r="2" fill="var(--color-surface)" />
      <circle cx="8" cy="12" r="2" fill="var(--color-surface)" />
      <circle cx="17" cy="17" r="2" fill="var(--color-surface)" />
    </>
  ),
  documents: (
    <>
...
export function Icon({ name, className }: { name: AnyIconName; className?: string }) {
  return (
    <svg
      viewBox="0 0 24 24"
